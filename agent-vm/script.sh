...
cd myagent
./config.sh --unattended --url https://dev.azure.com/sujethapai --auth pat --token 4yntpK7riMFJ1jZHnjBdPZFAligUd2EJGshHltRDpLEkaykJBhZ8JQQJ99BCACAAAAAAAAAAAAASAZDOLX6Q --pool Default --agent aksagent --acceptTeeEula
